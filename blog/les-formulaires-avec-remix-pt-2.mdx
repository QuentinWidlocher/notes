...
meta:
  ...
  description: Valider un formulaire et gérer les erreurs
---

Cet article fait suite à celui-ci : [Les formulaires avec Remix - Partie 1](/blog/articles/les-formulaires-avec-remix-pt-1)
