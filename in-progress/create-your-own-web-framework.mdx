...
By "with more modern tool", understand "with Javascript" of course. 😁

## What I want to do

I want to create a tool that's easy to learn and use, and makes a big use of the fundamentals of Javascript and the web.
I won't create a web server so I'll use Express, but I'll try to leverage Express capabilities the best I can, same goes for the templating system, I don't want to integrate JSX as I feel the \``template string ${interpolation}`\` is powerful enough.
...
It's kind of bare-bone but it's a great basis for the most advanced features coming next.
